...
$address = "contato@atomtech.com.br";
...
if (!empty($error))
{
	...
	echo '<strong>Attention!</strong> Please correct the errors below and try again.';
	echo '<br><br>';
...
echo '<strong>Error!</strong> Please confirm PHP mail() is enabled.';
echo '</div>';
